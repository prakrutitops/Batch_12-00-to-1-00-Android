...
interface ApiInterface
{
    ...
    fun flowercategory_viewdata() :Call<List<CategoryModel>>

    @GET("fashion_category_view.php")
    fun fashioncategory_viewdata() :Call<List<CategoryModel>>

    @GET("special_category_view.php")
    fun specialcategory_viewdata() :Call<List<CategoryModel>>
